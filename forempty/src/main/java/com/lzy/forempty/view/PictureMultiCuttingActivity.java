...
import com.lzy.forempty.view.callback.BitmapCropCallback;
import com.lzy.forempty.view.model.AspectRatio;
import com.lzy.forempty.view.model.CutInfo;
import com.lzy.forempty.view.util.FileUtils;
import com.lzy.forempty.view.util.SelectedStateListDrawable;
import com.lzy.forempty.view.view.CropImageView;
import com.lzy.forempty.view.view.GestureCropImageView;
import com.lzy.forempty.view.view.OverlayView;
import com.lzy.forempty.view.view.TransformImageView;
import com.lzy.forempty.view.view.UCropView;
import com.lzy.forempty.view.view.widget.AspectRatioTextView;
import com.lzy.forempty.view.view.widget.HorizontalProgressWheelView;
...
public class PictureMultiCuttingActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        adapter = new PicturePhotoGalleryAdapter(PictureMultiCuttingActivity.this, cutInfos);
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mToolbarCancelDrawable = intent.getIntExtra(UCropMulti.Options.EXTRA_UCROP_WIDGET_CANCEL_DRAWABLE, R.mipmap.ucrop_ic_cross);
        mToolbarCropDrawable = intent.getIntExtra(UCropMulti.Options.EXTRA_UCROP_WIDGET_CROP_DRAWABLE, R.mipmap.ucrop_ic_done);
...
//        findViewById(R.id.ucrop_frame).setBackgroundColor(mRootViewBackgroundColor);
    ...
    private void setupAspectRatioWidget(@NonNull Intent intent) {
        ...
        if (aspectRatioList == null || aspectRatioList.isEmpty()) {
            ...
            aspectRatioList.add(new AspectRatio(getString(R.string.ucrop_label_edit_photo).toUpperCase(),//R.string.ucrop_label_original
