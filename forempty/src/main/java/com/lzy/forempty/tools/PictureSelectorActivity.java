package com.lzy.forempty.tools;
...
import com.lzy.forempty.R;
import com.lzy.forempty.tools.adapter.PictureAlbumDirectoryAdapter;
import com.lzy.forempty.tools.adapter.PictureImageGridAdapter;
import com.lzy.forempty.tools.config.PictureConfig;
import com.lzy.forempty.tools.config.PictureMimeType;
import com.lzy.forempty.tools.decoration.GridSpacingItemDecoration;
import com.lzy.forempty.tools.dialog.CustomDialog;
import com.lzy.forempty.tools.entity.EventEntity;
import com.lzy.forempty.tools.entity.LocalMedia;
import com.lzy.forempty.tools.entity.LocalMediaFolder;
import com.lzy.forempty.tools.model.LocalMediaLoader;
import com.lzy.forempty.tools.observable.ImagesObservable;
import com.lzy.forempty.tools.permissions.RxPermissions;
import com.lzy.forempty.tools.rxbus2.RxBus;
import com.lzy.forempty.tools.rxbus2.Subscribe;
import com.lzy.forempty.tools.rxbus2.ThreadMode;
import com.lzy.forempty.tools.tools.DateUtils;
import com.lzy.forempty.tools.tools.DoubleUtils;
import com.lzy.forempty.tools.tools.PictureFileUtils;
import com.lzy.forempty.tools.tools.ScreenUtils;
import com.lzy.forempty.tools.tools.StringUtils;
import com.lzy.forempty.tools.tools.ToastManage;
import com.lzy.forempty.tools.widget.FolderPopWindow;
import com.lzy.forempty.tools.widget.PhotoPopupWindow;
import com.lzy.forempty.view.UCrop;
import com.lzy.forempty.view.UCropMulti;
import com.lzy.forempty.view.model.CutInfo;
...
import static com.lzy.forempty.tools.config.PictureConfig.FILE_PROVIDER;
...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    private Uri parUri(File cameraFile) {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.M) {
            ...
            imageUri = FileProvider.getUriForFile(mContext, FILE_PROVIDER, cameraFile);
        } else {
