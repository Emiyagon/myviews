package com.lzy.forempty.tools.config;
...
public final class PictureConfig {
    ...
    public final static int REQUEST_CAMERS = 908;
    public final static int REQUEST_CAMERD = 907;
    public final  static int GO_FOR_REACT = 501;
    public final static int READ_EXTERNAL_STORAGE = 0x01;
    public final static int CAMERA = 0x02;


    public static final String FILE_PROVIDER = "com.zhuosen.chaoqijiaoyu.fileprovider";
}
